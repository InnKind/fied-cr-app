// SOLO servidor: el "cerebro" de Atenea. Responde preguntas fundamentadas en la
...
export async function athenaAnswer(question: string): Promise<string> {
  const prompt =
    `Eres "Atenea", la asistente experta de Inn.Kind y su Foro Internacional de Educación ` +
